<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UyeGirisi.aspx.cs" Inherits="KitapTakipSistemiBoot.UyeGirisi" %>
...
<body>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control text-center" id="txtad" placeholder="Kullanıcı Adı" style="width:70%;margin-left:15%;">
  </div>
  <div class="form-group">
...
&nbsp;</label></div>
            ...
            <%--<asp:Button ID="Button1" runat="server" Text="Button" OnClick="Button1_Click" CssClass="btn btn-default"  />--%>
  <button type="button" class="btn btn-default" style="width:70%; background-color:aliceblue;" onclick="Giris()">Giriş</button>
</form>
    </div>
